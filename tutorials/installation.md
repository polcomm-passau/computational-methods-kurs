...
*Hinweis:* Falls Sie eine ältere Version von R oder RStudio auf Ihrem Rechner installiert haben, empfehlen wir ein Update durchzuführen (wir benutzen in diesem Kurs die **Version 4.1.1**). 

* Um die aktualisierte Version von R zu **installieren**, befolgen Sie einfach die nachstehenden Anweisungen. 
